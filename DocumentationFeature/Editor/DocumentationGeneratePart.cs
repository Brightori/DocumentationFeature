...
namespace Documenation.Generator
{
    public partial class CodeGenerator
    {
        public string GetDocumentation()
        {
            ...
            tree.Add(new UsingSyntax("Documenation.Core"));
            tree.Add(new UsingSyntax("System.Collections.Generic", 1));
            tree.Add(new NameSpaceSyntax("Documenation"));
            tree.Add(new LeftScopeSyntax());
            tree.Add(new TabSimpleSyntax(1, "public partial class Documentation"));
        ...
        {
            var tree = new TreeSyntaxNode();
            tree.Add(new TabSimpleSyntax(2, "public Documentation()"));
